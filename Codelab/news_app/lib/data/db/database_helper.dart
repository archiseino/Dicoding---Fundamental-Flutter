...
class DatabaseHelper {
  ...
  Future<Map> getNewsById(String url) async {
    final db = await database;

    List<Map<String, dynamic>> results = await db!.query(_tblBookmark, where: "url = ?", whereArgs: [url]);
  ...
  Future<void> removeBookmark(String url) async {
   ...
   await db!.delete(_tblBookmark, where : "url = ?", whereArgs: [url]);
  }
